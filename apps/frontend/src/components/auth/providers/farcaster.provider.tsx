...
// TODO: Re-enable when @neynar/react is updated to support React 19
export const FarcasterProvider = () => {
  const t = useT();
  return (
    <div className="cursor-not-allowed opacity-50 bg-[#855ECD] h-[44px] rounded-[4px] flex justify-center items-center text-white gap-[4px]">
      <svg
        width="21px"
        height="21px"
      ...
      <div>{t('farcaster_temporarily_disabled', 'Farcaster (Temporarily Disabled)')}</div>
    </div>
  );
};

// ButtonCaster - Disabled fallback component
// Used by wallet.provider.tsx and wrapcaster.provider.tsx
...
/* Original implementation - disabled due to @neynar/react compatibility
