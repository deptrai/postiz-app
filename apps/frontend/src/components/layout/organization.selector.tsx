    ...
    <>
      <div className="hover:text-newTextColor">
        <div className="group text-[12px] relative">
          ...
          {!asOpenSelect && (
            <div className="flex items-center gap-2 cursor-pointer px-2 py-1 rounded hover:bg-input/50">
              <svg
                width="20"
                height="20"
                viewBox="0 0 26 26"
